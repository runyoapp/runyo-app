...
menu.innerHTML=` <div style="padding:12px 14px;border-bottom:1px solid var(--border)"> <div style="font-family:var(--font-m);font-size:11px;color:var(--muted);overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${esc(email)}</div> </div> <button onclick="_closeAvatarMenu();openStats()" style="width:100%;background:none;border:none;padding:11px 14px;text-align:left;font-family:var(--font-m);font-size:11px;color:var(--text);cursor:pointer;display:flex;align-items:center;gap:8px" onmouseover="this.style.background='rgba(255,255,255,0.04)'" onmouseout="this.style.background='none'"> <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><rect x="3" y="14" width="4" height="7" rx="1"/><rect x="10" y="9" width="4" height="12" rx="1"/><rect x="17" y="4" width="4" height="17" rx="1"/></svg> Stats </button> <button onclick="_closeAvatarMenu();switchTab('settings')" style="width:100%;background:none;border:none;padding:11px 14px;text-align:left;font-family:var(--font-m);font-size:11px;color:var(--text);cursor:pointer;display:flex;align-items:center;gap:8px" onmouseover="this.style.background='rgba(255,255,255,0.04)'" onmouseout="this.style.background='none'"> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg> Instellingen </button> <button onclick="_closeAvatarMenu();authSignOut()" style="width:100%;background:none;border:none;border-top:1px solid var(--border);padding:11px 14px;text-align:left;font-family:var(--font-m);font-size:11px;color:var(--race-text);cursor:pointer;display:flex;align-items:center;gap:8px" onmouseover="this.style.background='rgba(244,67,54,0.06)'" onmouseout="this.style.background='none'"> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg> Uitloggen </button>`;
}else if(menu){
menu.remove();
}
}
...
sec.innerHTML=`<div style="font-family:var(--font-m);font-size:9px;color:var(--muted);letter-spacing:1.5px;text-transform:uppercase;margin-bottom:10px">PR BEWERKEN</div> ${existing.map(d=>`<div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
...
</div>`).join('')} ${remaining.length?`<select class="settings-input" style="margin-top:6px" onchange="if(this.value){const p=loadPRs();p[this.value]='';persistPRs(p);this.value='';renderStats();setTimeout(openPrEditor,50);}">
...
const displayName=(*em&&localStorage.getItem(’sheetName*’+_em))||state.sheetName||‘Schema’;
el.innerHTML=` <div style="display:flex;align-items:center;gap:8px;margin-bottom:12px"> <div style="width:8px;height:8px;border-radius:50%;background:var(--run-text);flex-shrink:0"></div> <div style="flex:1;min-width:0"> <div style="font-size:12px;font-weight:600;margin-bottom:2px">${esc(displayName)}</div> <a href="https://docs.google.com/spreadsheets/d/${esc(sheetId)}/edit" target="_blank" style="font-family:var(--font-m);font-size:10px;color:var(--accent);text-decoration:none">Sheet openen ↗</a> </div> </div> <div id="sheetPickerInline"></div> <button class="btn-save" style="width:100%;margin-top:8px" onclick="loadSheetPickerInline()">Ander schema koppelen</button> ${_devBlock()}`;
return;
}
...
</button>`; }).join('')} <div style="display:flex;gap:6px;margin-top:4px"> <input type="url" class="settings-input" id="inlineSheetUrl" placeholder="Of plak sheet URL…" style="flex:1"> <button class="btn-save" onclick="oauthSelectFromUrl()">OK</button> </div> </div>`;
